...
var BlueTab = /** @class */ (function (_super) {
    ...
    BlueTab.prototype.previewChildrenStates = function (tabState, timeRatioLeft) {
        ...
        _super.prototype.previewChildrenStates.call(this, tabState, timeRatioLeft);
    };
    BlueTab.prototype.removePreviewChildrenStates = function () {
        $('#' + this.identifier + '_changes').addClass("hidden");
