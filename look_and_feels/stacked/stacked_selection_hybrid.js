function StackedSelectionHybrid(oldElement, controller, label) {
    this.identifier = oldElement.attr("id");
    this.controller = controller;
    this.initHTML(oldElement, label);
    this.initBehavior();
}
StackedSelectionHybrid;
SelectionHybrid();
StackedSelectionHybrid.prototype.extendPrototype({
    initHTML: function (oldElement, label) {
        var newHTML = '';
        newHTML += '<div class="selection_hybrid" id="' + this.identifier + '_stacked">';
...
//# sourceMappingURL=stacked_selection_hybrid.js.map